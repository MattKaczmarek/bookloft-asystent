...
function openImageModal(imageUrl) {
  ...
  overlay.style.overflow = 'auto';  // pozwala na wyświetlenie pełnego obrazu, nawet jeśli przekracza viewport

  // Kontener na zdjęcie – ustawiamy go na block, bez ograniczeń rozmiaru
  ...
  container.style.margin = '20px auto'; // centrowanie kontenera
  ...
  // Ustawiamy obrazek w jego naturalnych wymiarach – bez transformacji
  ...
  // Mechanizm zoom i przesuwania – inicjujemy dopiero przy interakcji
  let scale = 1;
  let posX = 0;
  let posY = 0;
